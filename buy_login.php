...
if(isset($_POST['Submit']))
{
   ...
   if(strlen($_POST['Username']) < 1 || strlen($_POST['Password']) < 1 || 
	...
	{
	 	$_SESSION['error'] = 'No such user exist in our database';
	 	header("Location:buy_login.php");
	 	return;
	}
	else
	{
     while ($row = mysqli_fetch_assoc($result)) 
     {
      ...
      {
        $_SESSION['error']  = "You probably entered wrong college";
        header("Location:buy_login.php");
        return;
      }
...
<?php
echo("<p align ='center'><a href='pass.php?key=".'b'."'>Forgot Password?? </a></p><br><br>");
echo("<p align ='center' style = 'color:black;'> NOT REGISTERED DON'T WORRY </p>");
echo("<p align='center' style='color:red;'>" ."<a href = 'buyer_request.php'>Click to register</a>". "</p>")
?>