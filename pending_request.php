...
session_start();
    ...
    $qry = "SELECT * FROM pending_request WHERE College='$college'";
    ...
    if(isset($_POST['edit']))
    {
        ...
        $qry = "DELETE FROM pending_request WHERE College='$college'";
        $result = mysqli_query($link,$qry);
        ...
        for($i = 0;$i<9;$i++)
        {
            ...
            $qry = "INSERT INTO pending_request(Email,Type,College,Roll_No) VALUES('$requestor','$type','$college','$roll_no')";
             $result = mysqli_query($link,$qry);
    ...
    <form method="post">
         <?php
	        ...
	        foreach($positions as $position)
	        {
                ...
                echo("</p>");
               echo('<p>Roll_No:<input type="text" readonly="readonly" name="roll_no'.$pos.'"');
	        	echo('value = "'.$position['Roll_No'].'"/>');
                echo('<p>Type:<input type="text" readonly="readonly" name="type'.$pos.'"');
	        	echo('value = "'.$position['Type'].'"/></p>');
