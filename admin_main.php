...
<div class="full-menu">
	<div class="fullmenu-content">
		<ul class="page-menu">
            ...
            <li><a href="update_user.php">Add/Delete User</a></li>
			<li><a href="update_provider.php">Add/Delete Provider</a></li>
			<li><a href="update_product.php">Add/Delete Products</a></li>
...
<section class="main">
	<div class="main-content">
        <span class="hello" style="font-size: 3em;color: yellow;">Welcome Admin!</span>
